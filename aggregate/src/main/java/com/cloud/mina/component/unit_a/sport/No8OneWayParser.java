...
/**
 * unitA 公司智能终端运动数据包口号数据包）解码器
 */
@Component
public class No8OneWayParser extends UnitASportComponent {
    ...
    public PackageData generateRealPackageData(IoBuffer buffer) {
        ...
        levell_b[1] = buffer.get(37);
        levell_b[0] = buffer.get(38);
        ...
        int levell = DataTypeChangeHelper.byte2int(levell_b) * 2;
